...
{
    return GetBoolArg("-testnet", false) ? 17814 : 7814;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop FreeCoin server (and possibly override the detachdb config value).");
